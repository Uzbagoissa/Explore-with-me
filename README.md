...
# Приложение смесь Tinder и Афишы - позволяет пользователям делиться информацией об интересных событиях и находить компанию для участия в них.

## Примененный стек технологий: Spring Boot, Maven, Hibernate, Lombok, Postgres, Docker
